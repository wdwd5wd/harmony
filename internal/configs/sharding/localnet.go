...
var (
	...
	localnetV0 = MustNewInstance(2, 170, 170, numeric.OneDec(), genesis.LocalHarmonyAccountsDIY2, genesis.LocalFnAccountsDIY2, localnetReshardingEpoch, LocalnetSchedule.BlocksPerEpoch())
	localnetV1 = MustNewInstance(2, 170, 170, numeric.OneDec(), genesis.LocalHarmonyAccountsV1DIY2, genesis.LocalFnAccountsV1DIY2, localnetReshardingEpoch, LocalnetSchedule.BlocksPerEpoch())
	localnetV2 = MustNewInstance(2, 170, 170, numeric.MustNewDecFromStr("0.68"), genesis.LocalHarmonyAccountsV2DIY2, genesis.LocalFnAccountsV2DIY2, localnetReshardingEpoch, LocalnetSchedule.BlocksPerEpoch())
)
