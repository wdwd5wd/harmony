...
func (consensus *Consensus) checkDoubleSignDIY(recvMsg *FBFTMessage) bool {
	if consensus.couldThisBeADoubleSignerDIY(recvMsg) {
...
func (consensus *Consensus) couldThisBeADoubleSignerDIY(
	recvMsg *FBFTMessage,
) bool {
